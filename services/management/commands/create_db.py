...
SERVICE_INFOS = [
    ('Диагностика и ремонт Webasto', 'repair', '60 минут', '60 б.р.', '6 месяцев', 'Это оборудование максимально'
    ...
    ('Автостекла для легковых и грузовых автомобилей', 'service', '55 минут', 'от 38 б.р.', '6 месяцев',
    ...
    ('Автоэлектрика', 'electric', 'от 45 минут', 'от 20 б.р.', '6 месяцев', 'Электрооборудование автомобиля – группа'
